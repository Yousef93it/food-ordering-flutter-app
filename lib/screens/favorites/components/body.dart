...
class Body extends StatelessWidget {
  ...
  final List<Map<String, String>> favoritesDemo = [
    {"id": "m1", "title": "Sushi plate", "image": "assets/images/Ebi Fry.jpeg"},
    {"id": "m2", "title": "Ebi Fry", "image": "assets/images/Ebi Fry.jpeg"},
    {
      "id": "m3",
      "title": "Okinawa Sushi",
    ...
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (ctx, index) => Column(
          children: [
            FavoritesItem(favoritesDemo[index]["id"],
                favoritesDemo[index]["title"], favoritesDemo[index]["image"]),
            const Divider(),
          ],
        ),
      ),
